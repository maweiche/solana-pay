...
export default function Checkout() {
  ...
  // Generate the uniqe reference which will be used for this transaction
  ...
  // Send th transaction once it is fetched
  useEffect(() => {
    trySendTransaction()
  }, [transaction])
  ...
  useEffect(() => {
    const interval = setInterval(async () => {
      try {
        // check if ther are any transactions for the specific reference
